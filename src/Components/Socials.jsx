  ...
  return (
    <StyledWrapper>
      <div className="button-container">
        <a href="https://www.instagram.com/rawtuna35" target="_blank" rel="noopener noreferrer">
        ...
        <a href="https://github.com/tuanqchau" target="_blank" rel="noopener noreferrer">
            <button className="button flex-center">
        ...
        <a href="https://www.linkedin.com/in/tuan-chau-5566ba1b4/" target="_blank" rel="noopener noreferrer">
            <button className="button flex-center">
            <svg
                height="22px"       // match your other icons
            ...
            >
                ...
                H65.345c-5.554,0-10.056-4.502-10.056-10.056V150.403c0-5.554,4.502-10.056,10.056-10.056h42.806c5.554,0,10.056,4.502,10.056,10.056
                V329.844z M86.748,123.432c-22.459,0-40.666-18.207-40.666-40.666S64.289,42.1,86.748,42.1 s40.666,18.207,40.666,40.666
                S109.208,123.432,86.748,123.432z M341.91,330.654c0,5.106-4.14,9.246-9.246,9.246H286.73c-5.106,0-9.246-4.14-9.246-9.246
                v-84.168c0-12.556,3.683-55.021-32.813-55.021c-28.309,0-34.051,29.066-35.204,42.11v97.079c0,5.106-4.139,9.246-9.246,9.246
                h-44.426c-5.106,0-9.246-4.14-9.246-9.246V149.593c0-5.106,4.14-9.246,9.246-9.246h44.426c5.106,0,9.246,4.14,9.246,9.246v15.655
