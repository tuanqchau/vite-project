...
const Photos = () => {
  const allPhotos = [
    { id: 31, src: wy1, fullSize: wy1 },
    { id: 32, src: wy2, fullSize: wy2 },
    { id: 33, src: wy3, fullSize: wy3 },
    { id: 34, src: wy4, fullSize: wy4 },
    { id: 35, src: mt1, fullSize: mt1 },
    { id: 36, src: mt2, fullSize: mt2 },
    { id: 37, src: mt3, fullSize: mt3 },
    { id: 38, src: mt4, fullSize: mt4 },
  ...
  const [displayedPhotos, setDisplayedPhotos] = useState(allPhotos);
  ...
  const handleAlbumChange = (album) => {
    ...
    } else if (album === 'Vietnam') {
      setDisplayedPhotos(vietnamPhotos);
    }
  };

  return (
    <div className='photos-container page-transition'>
      {/* <div className='photos-header'>
        <h1>Photo Collection</h1>
        <p>Browse through my photography collection from various locations and experiences</p>
      </div> */}
      ...
      {/* <div className='album-selector'>
        ...
        <button 
          className={`album-button ${currentAlbum === 'Vietnam' ? 'active' : ''}`}
          onClick={() => handleAlbumChange('Vietnam')}
        >
          Vietnam
        </button>
      </div> */}
      ...
      {selectedPhoto && (
        <div className={`modal ${selectedPhoto ? 'open' : ''}`} onClick={handleCloseModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <motion.img 
              ...
              alt={`Full-size Photo ${selectedPhoto.id}`} 
            />
          </div>
        </div>
      )}
